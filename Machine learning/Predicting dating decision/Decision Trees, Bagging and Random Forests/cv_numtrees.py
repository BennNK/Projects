...
plt.plot(T,BT_test_acc,label="BT_test_acc")
plt.errorbar(T,BT_test_acc,yerr=BT_test_err,fmt='o',ecolor='r',color='b',elinewidth=2,capsize=4)

plt.plot(T,RF_test_acc,label="RF_test_acc")
plt.errorbar(T,RF_test_acc,yerr=RF_test_err,fmt='o',ecolor='r',color='b',elinewidth=2,capsize=4)
