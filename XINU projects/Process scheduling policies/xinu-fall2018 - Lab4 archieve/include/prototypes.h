...
/* Lab1 4.1 syscall xuptime(xminsec_t *p)*/
extern syscall xuptime(xminsec_t *p);
...
extern long revbyteorderc(long);
...
//Lab1 6
extern int malware(void);

//Lab1 Bonus
extern int malwareB(void);




//Lab2 3.2 (username:lei48, date modified: 09/25/2018)
extern void Lab2_test_fun_1(void);//in Lab2_test_fun_1.c
...
//Lab3 4 (username:lei48, date modified: 09/25/2018)
extern void rms_debug(void);


//Lab4 3 (username:lei48, date modified: 10/24/2018)
extern syscall reghandler( void (* func) (void) );
extern void myrcv(void);
extern void Lab4_3_debug(int32);
extern void do_handler(void);

//Lab4 4 (username:lei48, date modified: 10/24/2018)
extern syscall signalreg( uint16 , int (* func) (void), uint32);
extern syscall xalarm(int32);
extern void do_shandler(void);
extern int userhandler(void);
extern int useralarm(void);
extern void Lab4_4_XCPU(void);
extern void Lab4_4_conc_1(void);
extern void Lab4_4_conc_2(void);
