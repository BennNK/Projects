...
inverted_page_table	ipagetab[NFRAMES];//global inverted page table
uint32  pf_counter;//global counter recording total count of page faults
sid32	pgft_sem;//page fault semaphore
//end of Lab5
...
static	void	sysinit()
{
	...
	//Lab5 lei48 (lei48 11/09/2018)
	 	prptr->hsize=0;
  struct	memblk	*memptr= &prptr->virtual_memlist;
  memptr->mlength = 0;
