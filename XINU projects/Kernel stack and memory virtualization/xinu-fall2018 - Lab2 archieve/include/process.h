/* process.h - isbadpid */
 ...
 //Lab2 5.4 (username:lei48, date modified: 09/25/2018)
 #define	IOPRIO	21	/* IO-bound process priority		*/
 #define XINUSCHED 1 //default is 0 for legacy mode of resched. 1 for R3 mode.
 
 //end of Lab2 5.4 (username:lei48, date modified: 09/25/2018)
