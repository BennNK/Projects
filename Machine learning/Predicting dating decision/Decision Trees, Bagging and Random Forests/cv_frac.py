...
plt.plot(F,DT_test_acc,label="DT_test_acc")
plt.errorbar(F,DT_test_acc,yerr=DT_test_err,fmt='o',ecolor='r',color='b',elinewidth=2,capsize=4)

plt.plot(F,BT_test_acc,label="BT_test_acc")
plt.errorbar(F,BT_test_acc,yerr=BT_test_err,fmt='o',ecolor='r',color='b',elinewidth=2,capsize=4)

plt.plot(F,RF_test_acc,label="RF_test_acc")
plt.errorbar(F,RF_test_acc,yerr=RF_test_err,fmt='o',ecolor='r',color='b',elinewidth=2,capsize=4)
